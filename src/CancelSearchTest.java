...
public class CancelSearchTest {
    ...
    @Test
    public void checkResultsAndClear() {
        ...
        waitForElementAndCheckResults(
                By.id("org.wikipedia:id/page_list_item_container"),
                "There are no results or there is only one result",
                5
        );
    ...
    private List<WebElement> waitForElementAndCheckResults(By by, String error_message, long timeoutInSeconds)
    {
        WebDriverWait wait = new WebDriverWait(driver, timeoutInSeconds);
        wait.withMessage(error_message + "\n");
        return wait.until(
